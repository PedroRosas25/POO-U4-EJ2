...
class Iva(tkinter.Tk):
    ...
    def __init__(self):
        ...
        tkinter.Label(self,text="Pecio sin IVA",bg='aquamarine2').grid(column=1,row=2,sticky=(W))
        self.ingresadoEntry = tkinter.Entry(self,width=14,textvariable=self.__ingresado,bg='aquamarine2')
        self.ingresadoEntry.grid(column=2,row=2,sticky=(W))
        tkinter.Radiobutton(self,text="IVA 21%",value=0,variable=self.valor,command=self.calculaIva,bg='aquamarine2').grid(column=1,row=3,sticky=(W))
        tkinter.Radiobutton(self,text="IVA 10,5%",value=1,variable=self.valor,command=self.calculaIva,bg='aquamarine2').grid(column=1,row=4,sticky=(W))
        tkinter.Label(self,text="IVA",bg='aquamarine2').grid(column=1,row=5,sticky=(N,W,E,S))
        tkinter.Label(self,text="Precio con IVA",bg='aquamarine2').grid(column=1,row=6,sticky=(N,W,E,S))
        tkinter.Label(self,textvariable=self.__iva,bg='aquamarine2').grid(column=2,row=5,sticky=((W)))
        tkinter.Label(self,textvariable=self.__total,bg='aquamarine2').grid(column=2,row=6,sticky=((W)))
